...
func handleAIIncubatorPitchSubmit(ctx context.Context, cmd *cli.Command) error {
	...
	params := jamesburvelocallaghaniiicitibankdemobusinessinc.AIIncubatorPitchSubmitParams{}
...
func handleAIIncubatorPitchSubmitFeedback(ctx context.Context, cmd *cli.Command) error {
	...
	params := jamesburvelocallaghaniiicitibankdemobusinessinc.AIIncubatorPitchSubmitFeedbackParams{}
