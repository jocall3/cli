...
//
// [README]: https://pkg.go.dev/github.com/jocall3/cli#readme-requestoptions
...
// WithBiometricToken returns a RequestOption that sets the client setting "biometric_token".
